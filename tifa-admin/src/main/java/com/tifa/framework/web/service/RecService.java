...
//        MongoCollection<Document> itemCFProductsCollection = mongoClient.getDatabase(TifaConstant.MONGODB_DATABASE).getCollection(TifaConstant.PRODUCT_SIMILARITY_RECS_COLLECTION);
